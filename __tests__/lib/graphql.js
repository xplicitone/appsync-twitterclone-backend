// use apollo client, amplify. show how can do it with normal HTTP requests. Ultimately GraphQL are HTTP request. Do it hard way to learn better.
//axios http client library for js that lets us use promises.
