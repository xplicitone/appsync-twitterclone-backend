...
describe('Given an authenticated user', () => {
  ...
  // after invoke, expect tweet to be in tweets and timeline table and tweetscount should be from 0 to 1 inside users table
  describe('When he sends a tweet', () => {
    ...
    it('Increments the tweet count in the Users table to 1', async () => {
